...
| C3 | Crypto Fear & Greed (alternative.me, 2018-02→, niveau + Δ7j) → BTC/ETH fwd 1-20j — ADDENDUM 2026-07-12, demande utilisateur | fng.py | ✗ rien ne passe la barre (BTC : p 0,07-0,34, t<2, tout le signal dans la moitié 2018-21 ; ETH pareil). **SIGNE MOMENTUM, PAS CONTRARIAN** : extreme greed ≥80 → fwd10j +8,0%/fwd20j +13,1% vs base +0,9% ; extreme fear ≤20 → +1,0% ≈ base — « vendre l'avidité » aurait raté les meilleures fenêtres. AUCUN bucket à forward négatif = rien à vendre pour l'accumulation. Redondance prix : corr +0,75 avec roc_30 ET dd_120 = momentum repackagé, la composante sociale n'ajoute rien. Famille sentiment : 0/5 (funding, basis, breadth, alt-share, FNG) |
