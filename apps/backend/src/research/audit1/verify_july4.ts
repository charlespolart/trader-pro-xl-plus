...
import accumV2 from "./accum_july4"
...
console.log(`stratégie du 4 juillet (25c66fa) : net ${res.metrics.netProfitPct.toFixed(2)}% DD ${res.metrics.maxDrawdownPct.toFixed(2)}% ${res.metrics.totalTrades}tr (attendu baseline juillet : +61.9 / 29.6 / 57)`)
process.exit(0)
